...
/** Base shimmer placeholder — size/shape driven entirely by className/style. */
...
/** Mimics the fleet map's shape while devices/positions are loading: a faint
 * grid instead of a flat gray block, the style-toggle control outline, and a
 * handful of scattered pin dots suggesting markers about to appear. */
export function MapSkeleton() {
  return (
    <div className="relative h-full w-full overflow-hidden bg-surface-card">
      <div
        aria-hidden
