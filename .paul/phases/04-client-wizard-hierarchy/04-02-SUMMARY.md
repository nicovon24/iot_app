...
tech-stack:
  ...
  patterns:
    [
      "ParseUuidPipe for app-owned Postgres ids, mirroring ParseTbIdPipe's shape for ThingsBoard ids but kept as a separate pipe since the id spaces are semantically different",
    ]
...
_Phase: 04-client-wizard-hierarchy, Plan: 02_
