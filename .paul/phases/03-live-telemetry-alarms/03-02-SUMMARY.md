...
tech-stack:
  ...
  patterns:
    [
      'fan-out over scoped entity list instead of an unconfirmed tenant-wide alarm API',
      "polling+diff fallback for WS push when native subscription protocol isn't confirmed",
    ]
...
_Phase: 03-live-telemetry-alarms, Plan: 02_
